    ...
    <body>
        ...
        <ul class="clearfix">
            ...
            <li><a href="#">TECHNICAL<span class="arrow">&#9660;</span></a>
                <ul class="sub-menu">
                     <li><a href="after_select_sub.jsp?Id=CNS"><center>CNS</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=AI"><center>AI</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=HSN"><center>HSN</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=AOS"><center>AOS</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=SAO"><center>SAO</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=DS"><center>DS</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=NN"><center>NN</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=CC"><center>CC</center></a></li>
                </ul>
            </li>
            <li>
            <a href="#">REPORT</a>
