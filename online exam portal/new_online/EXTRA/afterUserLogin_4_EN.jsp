<%-- 
    Document   : afterUserLogin_4_EN
    Created on : 2 Oct, 2016, 12:46:10 AM
    ...
    <nav class="menu">
        <ul class="clearfix">
            ...
            <li><a href="#">TECHNICAL<span class="arrow">&#9660;</span></a>
                <ul class="sub-menu">
                     <li><a href= "after_select_sub.jsp?Id=ED"><center>ED</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=PSP"><center>PSP</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=ADC"><center>ADC</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=EEEM"><center>EEEM</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=UOEET"><center>UOEET</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=HVPE"><center>HVPE</center></a></li>
                </ul>
            </li>
            <li>
            <a href="#">REPORT</a>
