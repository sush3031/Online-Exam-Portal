<%-- 
    Document   : afterUserLogIn_3_IT
    Created on : 24 Sep, 2016, 7:16:11 PM
        ...
        <ul class="clearfix">
            ...
            <li><a href="#">TECHNICAL<span class="arrow">&#9660;</span></a>
                <ul class="sub-menu">
                     ...
                     <li><a href="after_select_sub.jsp?Id=MMA"><center>MMA</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=CBNST"><center>CBNST</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=SoftComputing"><center>SoftComputing</center></a></li>
