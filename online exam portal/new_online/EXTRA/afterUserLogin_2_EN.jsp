<%-- 
    Document   : afterUserLogin_2_EN
    Created on : 2 Oct, 2016, 12:45:40 AM
        ...
        <ul class="clearfix">
            ...
            <li><a href="#">TECHNICAL<span class="arrow">&#9660;</span></a>
                <ul class="sub-menu">
                     ...
                     <li><a href="after_select_sub.jsp?Id=THM"><center>THM</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=EMEC-1"><center>EMEC-1</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=EMMI"><center>EMMI</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=BSA"><center>BSA</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=ADM"><center>ADM</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=EMEC-2"><center>EMEC-2</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=NAS"><center>NAS</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=IPC"><center>IPC</center></a></li>
                </ul>
            </li>
            <li>
            <a href="#">REPORT</a>
