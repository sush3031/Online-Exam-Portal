<%-- 
    Document   : afterUserLogin_3_ME
    Created on : 2 Oct, 2016, 12:44:17 AM
    ...
    <nav class="menu">
        <ul class="clearfix">
            ...
            <li><a href="#">TECHNICAL<span class="arrow">&#9660;</span></a>
                <ul class="sub-menu">
                     <li><a href="after_select_sub.jsp?Id=MST-2"><center>MST-2</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=KOM"><center>KOM</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=MD-1"><center>MD-1</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=HMT"><center>HMT</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=ICEC"><center>ICEC</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=MD-2"><center>MD-2</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=DOM"><center>DOM</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=RAC"><center>RAC</center></a></li>
                </ul>
            </li>
            <li>
            <a href="#">REPORT</a>
