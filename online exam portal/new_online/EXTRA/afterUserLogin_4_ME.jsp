<%-- 
    Document   : afterUserLogin_4_ME
    Created on : 2 Oct, 2016, 12:45:14 AM
    ...
    <nav class="menu">
        <ul class="clearfix">
            ...
            <li><a href="#">TECHNICAL<span class="arrow">&#9660;</span></a>
                <ul class="sub-menu">
                     <li><a href= "after_select_sub.jsp?Id=CAD"><center>CAD</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=AE"><center>AE</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=QC"><center>QC</center></a></li>
                </ul>
            </li>
            <li>
            <a href="#">REPORT</a>
