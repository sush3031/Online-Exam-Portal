<%-- 
    Document   : afterUserLogin_4_IT
    Created on : 30 Sep, 2016, 2:38:40 AM
    ...
    <body>
        ...
        <ul class="clearfix">
            ...
            <li><a href="#">TECHNICAL<span class="arrow">&#9660;</span></a>
                <ul class="sub-menu">
                     <li><a href="after_select_sub.jsp?Id=DAA"><center>DAA</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=DBMS"><center>DBMS</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=PPL"><center>PPL</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=WT"><center>WT</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=EE"><center>EE</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=CS"><center>CA</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=CN"><center>CN</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=SE"><center>SE</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=DW"><center>DW</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=DM"><center>DM</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=CD"><center>CD</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=IM"><center>IM</center></a></li>
                </ul>
            </li>
            <li>
            <a href="#">REPORT</a>
