        ...
        <ul class="clearfix">
            ...
            <li><a href="#">TECHNICAL<span class="arrow">&#9660;</span></a>
                <ul class="sub-menu">
                     ...
                     <li><a href="after_select_sub.jsp?Id=DLD"><center>DLD</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=DSGT"><center>DSGT</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=DSUC"><center>DSUC</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=CS"><center>CS</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=AUTOMATA"><center>AUTOMATA</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=MP"><center>MP</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=OS"><center>OS</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=CG"><center>CG</center></a></li>
                </ul>
            </li>
            <li>
            <a href="#">REPORT</a>
