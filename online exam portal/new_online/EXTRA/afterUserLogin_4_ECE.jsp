    ...
    <body>
        ...
        <ul class="clearfix">
            ...
            <li><a href="#">TECHNICAL<span class="arrow">&#9660;</span></a>
                <ul class="sub-menu">
                     <li><a href="after_select_sub.jsp?Id=OC"><center>OC</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=DCN"><center>DCN</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=VLSI"><center>VLSI</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=WMC"><center>WMC</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=ON"><center>ON</center></a></li>                  
                </ul>
            </li>
            <li>
            <a href="#">REPORT</a>
