<%-- 
    Document   : afterUserLogin_2_ME
    Created on : 1 Oct, 2016, 4:28:24 PM
    ...
    <nav class="menu">
        <ul class="clearfix">
            ...
            <li><a href="#">TECHNICAL<span class="arrow">&#9660;</span></a>
                <ul class="sub-menu">
                     <li><a href= "after_select_sub.jsp?Id=Math-3"><center>Math-3</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=FM"><center>FM</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=MS"><center>MS</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=MOS"><center>MOS</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=THERMODYNAMICS"><center>THERMODYNAMICS</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=EMC"><center>EMC</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=AT"><center>AT</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=MSAT-1"><center>MSAT-1</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=MAM"><center>MAM</center></a></li>
                </ul>
            </li>
            <li>
            <a href="#">REPORT</a>
