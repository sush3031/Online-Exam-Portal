    ...
    <body>
        ...
        <ul class="clearfix">
            ...
            <li><a href="#">TECHNICAL<span class="arrow">&#9660;</span></a>
                <ul class="sub-menu">
                     <li><a href="after_select_sub.jsp?Id=TP"><center>TP</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=CS-2"><center>CS-2</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=CPC"><center>CPC</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=OCS"><center>OCS</center></a></li>                      
                </ul>
            </li>
            <li>
            <a href="#">REPORT</a>
