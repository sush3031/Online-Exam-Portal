<%-- 
    Document   : afterUserLogin_3_EN
    Created on : 2 Oct, 2016, 12:45:54 AM
    ...
    <nav class="menu">
        <ul class="clearfix">
            ...
            <li><a href="#">TECHNICAL<span class="arrow">&#9660;</span></a>
                <ul class="sub-menu">
                     <li><a href= "after_select_sub.jsp?Id=EPS"><center>EPS</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=PE"><center>PE</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=CS"><center>CS</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=MP"><center>MP</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=FEMT"><center>FEMT</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=PSA"><center>PSA</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=SP"><center>SP</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=SEM"><center>SEM</center></a></li>
                </ul>
            </li>
            <li>
            <a href="#">REPORT</a>
