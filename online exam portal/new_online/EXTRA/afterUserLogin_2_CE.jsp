        ...
        <ul class="clearfix">
            ...
            <li><a href="#">TECHNICAL<span class="arrow">&#9660;</span></a>
                <ul class="sub-menu">
                     ...
                     <li><a href="after_select_sub.jsp?Id=EMC"><center>BMC</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=MS"><center>MS</center></a></li>
                     <li><a href="#after_select_sub.jsp?Id=CS"><center>CS</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=SURVEYING-1"><center>SURVEYING-1</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=SA-1"><center>SA-1</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=GI"><center>GI</center></a></li>
                     <li><a href="after_select_sub.jsp?Id=HHM"><center>HHM</center></a></li>
                </ul>
            </li>
            <li>
            <a href="#">REPORT</a>
