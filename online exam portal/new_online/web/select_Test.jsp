<%-- 
    ...
    Created on : 5 Apr, 2017, 11:55:05 PM
...
<html>
    ...
    <%
        ...
        String sub = (String)request.getParameter("subjects");
        try
        {
            ...
            ResultSet rs;
            rs = st.executeQuery("select test_id from before_addtest join subjects on before_addtest.teach_id='"+name+"' AND subjects.sub_name='"+sub+"' and before_addtest.sub_name=subjects.sub_id");
       %>
            <div class="middle">
               <center><font id="add"><u>Select test ID</u></font></center>
               <form action="ShowResults.jsp" name="selectTest" onsubmit=" return validateSelectTest()" method="post" autocomplete="on">
                <br>
                <center>
                <table>
                <tr><td></td><td></td></tr>
                <tr><td></td><td></td></tr>
                <tr>
                   <td><font class="textFont">Test: </font></td>
                ...
                <tr>
                    <td></td>
                    <td>*After 3 digits show the test number</td>
                </tr>
                <%
                    if(rs != null)
                    {
